...
public class DetailsMusees extends AppCompatActivity implements OnMapReadyCallback {
    Firebase mRef;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DB_URL="https://histoiretunisie-fa10e.firebaseio.com/musee/"+id+"/detailsList/";
