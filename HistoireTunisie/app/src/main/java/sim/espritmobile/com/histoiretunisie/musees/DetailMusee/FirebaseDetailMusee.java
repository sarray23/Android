package sim.espritmobile.com.histoiretunisie.musees.DetailMusee;
...
public class FirebaseDetailMusee extends AppCompatActivity {
    Firebase mRef;
    Context context;
    RecyclerView rv;
    String DB_URL;
    ...
    public FirebaseDetailMusee( Context context, String DB_URL,RecyclerView rv)  {
        this.DB_URL = DB_URL;
