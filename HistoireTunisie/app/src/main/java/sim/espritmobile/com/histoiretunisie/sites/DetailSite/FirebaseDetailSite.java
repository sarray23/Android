package sim.espritmobile.com.histoiretunisie.sites.DetailSite;
...
public class FirebaseDetailSite extends AppCompatActivity {
    Firebase mRef;
    Context context;
    RecyclerView rv;
    String DB_URL;
    ...
    public FirebaseDetailSite(Context context, String DB_URL, RecyclerView rv)  {
        this.DB_URL = DB_URL;
